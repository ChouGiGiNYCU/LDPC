...
int main(){
    string frozen_bits_position = "Polar64_Frozen_Bits_pos.txt";
    string non_frozen_bits_position = "Polar64_non_frozen_bits_pos.txt";
...
//*
    ...
    ofstream out;
    out.open("Polar64_Dence_PCM.txt",ios::trunc);
    if (!out.is_open()) {
    ...
    // --------
    out.open("Polar64_Dence_PCM_G.txt",ios::trunc);
    if (!out.is_open()) {
        cout << "Failed to open file";
        return 1;
    }
