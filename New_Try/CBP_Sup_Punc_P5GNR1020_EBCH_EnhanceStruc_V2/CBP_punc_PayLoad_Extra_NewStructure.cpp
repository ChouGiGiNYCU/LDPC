...
int main(int argc,char* argv[]){
    ...
    */
    ...
    boost::dynamic_bitset<> Real_transmit_codeword(H.n);
    ...
    while(SNR <= SNR_max){
        ...
        while(payload_frame_error < frame_error_lowwer_bound){
            ...
            for(auto& table:Superpostion_Payload_Extra_NewStructure){
                int extra_vn1  = table.extra_vn1;
                int extra_vn2  = table.extra_vn2;
                int payload_vn_nonpunc  = table.payload_vn_nonpunc;
                int payload_vn_punc  = table.payload_vn_punc;
                transmit_codeword[payload_vn_punc] = payload_Encode[payload_vn_punc] ^ payload_Encode[payload_vn_nonpunc] ^ extra_Encode[extra_vn1] ^  extra_Encode[extra_vn2];
            }
            /*------------------------------------------*/
            // Count LLR
