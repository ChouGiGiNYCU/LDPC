...
H_combine = [  
                ...
                punc_payload_mat_NewStructure2 ,   right_diag  , zero9 ,   I   ,    I;
...
T = table([1:H2_c].',[H2_c:-1:1].',punc_pos_bits_New_Struct1.',(punc_pos_bits_New_Struct2).','VariableNames', {'Extra bits1','Extra bits2','Payloadb_NonPunc(b)', 'Payloadc_Punc(c)'});  % 建立 table
