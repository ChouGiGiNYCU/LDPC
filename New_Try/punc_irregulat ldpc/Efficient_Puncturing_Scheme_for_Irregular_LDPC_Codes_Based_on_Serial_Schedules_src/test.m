...
% H_combine_file = 'PCM_Punc_newAlg_Punc96.txt';
puncture_position_bits_file = "Punc5GNR1020_Z15_Pos30.txt";
puncture_bits_num = 30+2*Z;
...
punc_pos_bits = Efficient_Puncturing_Scheme_for_Irregular_LDPC(H1,puncture_bits_num,Already_Punc_VNs);
%%
