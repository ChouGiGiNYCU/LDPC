...
H_combine_file = 'PCM_Punc_SerialSchedules_Punc96.txt';
...
Already_Punc_VNs = [];
lmax = 10;
punc_pos_bits = Efficient_Puncturing_Scheme_for_Irregular_LDPC(H1,puncture_bits_num,Already_Punc_VNs,lmax);
%%
