...
H_combine_file = 'PCM_P1008_E96_Structure_Partial_Combine_50percent.txt';
...
punc_pos_bits = Puncturing_Algorithm_For_Finit_Length(H1,Payload_punc_bits_num); % start idx = 1
