    ...
    while(SNR <= SNR_max){
        ...
        while(payload_frame_error < frame_error_lowwer_bound){
            ...
            while(it<iteration_limit && (payload_error_syndrome || extra_error_syndrome)){
                ...
                // if(!payload_error_syndrome){
                //     cout << "PayLoad CodeWord is decode(syndrome is zero) - it : " << it << endl;
                // }
                ...
                //     cout << "syndrome check is successfule but decode is other codeword !!" << endl;
                // }
                /* ----- Determine Extra BER ----- */
