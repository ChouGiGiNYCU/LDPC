...
H2_file = 'C:\Users\USER\Desktop\LDPC\PCM\Polar_16_fix.txt'; % extra data
H_combine_file = 'PCM_P5G1904_E16Polr_NewStructure_Partial50percent.txt';
...
Payload_punc_bits_num = H2_c * 2 + length(Already_punc_5G); % 總共 punc bits 為 Extra(部分Superposition、Extra傳送) + New_Structure1、2
punc_pos_bits = maximize_oneSR_method(H1,Payload_punc_bits_num,Already_punc_5G); % start idx = 1
...
punc_pos_bits_New_Struct2 =  punc_pos_bits(H2_c*2+1:end); % 被 punc
