...
int main(int argc,char* argv[]){
    ...
    while(SNR <= SNR_max){
        ...
        while(payload_frame_error < frame_error_lowwer_bound){
            ...
            // ofstream file("payload_code.txt");
            // for(int i=0;i<payload_Encode.size();i++){
            //     file << payload_Encode[i] << "\n";
            // }
            // file.close();
            // ofstream file1("Extra_code.txt");
            // for(int i=0;i<extra_Encode.size();i++){
            //     file1 << extra_Encode[i] << "\n";
            // }
            // file1.close();
            // ofstream file2("transmit_code.txt");
            // for(int i=0;i<transmit_codeword.size();i++){
            //     file2 << transmit_codeword[i] << "\n";
            // }
            // file2.close();
            /*------------ LLR position swap ------------*/
