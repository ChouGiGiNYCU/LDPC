...
H_combine_file = 'PCM_5GNR1020_Polar16_1SR.txt';
...
punc_pos_bits = Rate_Compatible_Punctured_With_Short_Block_Lengths(PayloadH.mat,punc_bits_num,Already_punc_5G);
