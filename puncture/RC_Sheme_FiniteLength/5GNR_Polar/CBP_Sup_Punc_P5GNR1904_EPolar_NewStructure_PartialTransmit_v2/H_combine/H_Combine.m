...
H_combine_file = 'PCM_P5G1904_E16Polr_NewStructure_Partial50percent_RCScheme.txt';
...
Payload_punc_bits_num = H2_c * 3 + length(Already_punc_5G) ; % 總共 punc bits 為 Extra(部分Superposition、Extra傳送) + New_Structure1、2
