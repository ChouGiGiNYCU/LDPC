...
Load_model_file_name = r'C:\Users\giginycu\Desktop\LDPC\python_LDPC\LDPC_96_48\show_all_parameter\BPNN_Mulitiloss_H9648_8_valid.pth'
Load_setting = True
...
for key,dict in VN2CN_dict.items():
    ...
    if len(node)==0:
        ...
        for neourn in node:
            ...
            # write data
            for it in  range(iteration):
                weight_data_cn2vn_str = f"{it} {prev_cn} {prev_vn} {layer_data[it][key][neourn]}"
