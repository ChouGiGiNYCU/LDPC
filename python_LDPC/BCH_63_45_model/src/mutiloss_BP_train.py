...
from parity_check_matrix import get_parity_check_matrix
from sparse_bp_model import SparseBPNeuralNetwork
################# Some parameter setting #################
file_name = "BCH_63_45.txt" # write parity_check_matrix to the txt file 
train_data_file_name = r"BCH_63_45_EncodeCodeWord_LLR_SNR_train.txt"
train_data_target_file_name = r"BCH_63_45_EncodeCodeWord_SNR_train.txt"
valid_data_file_name = r"BCH_63_45_EncodeCodeWord_LLR_SNR_valid.txt"
valid_data_target_file_name = r"BCH_63_45_EncodeCodeWord_SNR_valid.txt"
Encode_Train_Flag = True
Save_model_file_name = "BPNN_Mulitiloss_TrainEncode_"
Load_model_file_name = r'D:\BP_Model\BCH_63_45_model\new_version_addbias_mutilose\BP_NeuralNetwork_Mulitiloss_24_valid.pth'
Load_setting = False
learning_ratio = 0.001
epochs = 40
batch_size = 300 # (0~5) *50 
################# Some parameter setting #################
