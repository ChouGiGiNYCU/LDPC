function EXIT(H,SNR,rate)
    ...
    plot(real(I_A), real(I_EV), 'm-', 'LineWidth', 2);             % VND curve
    plot(real(I_EC), real(I_A), 'k-', 'LineWidth', 2);             % CND curve (inverted axes)
    ...
    legend('Origin - VND', 'Origin - CND (inverted)', 'Location', 'southeast');
    axis([0 1 0 1]);
