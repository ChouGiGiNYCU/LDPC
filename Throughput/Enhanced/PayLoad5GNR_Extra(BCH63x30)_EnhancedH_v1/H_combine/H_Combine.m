...
H_combine_file = 'PCM_P5GNR_EBCH63X30_EnhanceStruc_kSR.txt';
...
Already_punc = 1:(2*Z);
Payload_punc_bits_num = H2_c * 3 + numel(Already_punc); % 總共 punc bits 為 Extra(部分Superposition、Extra傳送) + New_Structure2
