...
H2_file = 'C:\Users\USER\Desktop\LDPC\PCM\BCH_63_30.txt'; % extra data
H_combine_file = 'PCM_P5G1020_EBCH63x30_EnhanceStruc.txt';
New_puncture_position_bits_outfile = "ExtraVNs_NewStrcuture.csv";
Superposition_outfile = "Table_Superposition_Extra_Payload.csv";
...
Payload_punc_bits_num = RV1_num + H2_c*2 + length(Already_punc_5G) ; % 總共 punc bits 為 Extra(部分Superposition、Extra傳送) + New_Structure2
...
RV1_punc_bits = punc_pos_bits(2*H2_c+1:end); % 被 punc
...
H_combine = [  
                ...
                zero3 ,                              H2    , zero5 , zero6 , zero6;
                sup_payload_mat ,                    I_sup , I_sup , zero7 , zero7;
...
writetable(T, Superposition_outfile);  % 輸出 csv
