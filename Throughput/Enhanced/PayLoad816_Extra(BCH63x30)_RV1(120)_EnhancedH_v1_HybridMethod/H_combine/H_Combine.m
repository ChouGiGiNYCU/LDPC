...
H_combine_file = 'PCM_P816_EBCH63x30_EnhanceStruc_kSR.txt';
...
Already_punc = [];
Payload_punc_bits_num = H2_c * 2 + RV1_num ; % 總共 punc bits 為 Extra(部分Superposition、Extra傳送) + New_Structure2
