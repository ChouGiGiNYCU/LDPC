...
H2_file = 'C:\Users\USER\Desktop\LDPC\PCM\H_32_16_CCSDS.txt'; % extra data
H_combine_file = 'PCM_P1008_EH32X16_EnhanceStruc_kSR.txt';
...
Already_punc = [];
Payload_punc_bits_num = H2_c * 2+63 ; % 總共 punc bits 為 Extra(部分Superposition、Extra傳送) + New_Structure2
