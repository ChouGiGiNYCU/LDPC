...
close all;
%%
H1_file = 'C:\Users\811\Desktop\LDPC\PCM\PEGReg504x1008.txt'; % payload data
H2_file = 'C:\Users\811\Desktop\LDPC\PCM\BCH_15_7.txt'; % extra data
...
Already_Punc_VNs = [99 106 108 129 184 190 253 311 399 438 476 681 779 800 872 ];
...
RV1_punc = Already_Punc_VNs;
payload_punc = punc_pos_bits;
%% check  punc_pos_bits ?òØ?ê¶?ÉΩ?òØ 1-SR
