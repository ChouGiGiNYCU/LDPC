...
int main(int argc,char* argv[]){
    ...
    while(SNR<=SNR_max){
        ...
        for(double frame_count=0;frame_count<total_frame_count;frame_count++){
            ...
            /* -----------------*/
            bool decode_flag_A = BP_for_Payload(PayLoad_H,iteration_limit,First_tx_LLR,A_CodeWord);
            ...
            /* ------------- Process B ------------- */
            bool decode_flag_B = BP_for_Payload(PayLoad_H,iteration_limit,Second_tx_LLR,A_CodeWord);
