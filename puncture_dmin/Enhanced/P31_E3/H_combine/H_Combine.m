...
H_combine_file = 'PCM_P31_EH3_EnhanceStruc_kSR.txt';
punc_file = "punc_pos.txt";
...
punc_pos_bits = union(punc_pos_bits,H1_c+1:H1_c+H2_c);
punc_pos_bits = union(punc_pos_bits,H1_c+H2_c*2+1:H1_c+H2_c*3);
fileID = fopen(punc_file, 'w');
